...
public class NBAPlayer implements ITaxPayer{
	private double m_income = -1;
	private boolean m_donePayingTaxes = false;
	
	public NBAPlayer (double income)
	{
		setM_income(income);
	}
	...
	public void FileTaxReturn()
	{
		if (m_donePayingTaxes)
		{
			System.out.println("NBAPlayer has filed tax return.");
		}
		else 
		{
			System.out.println("NBAPlayer needs to pay taxes before filing tax return.");
		}
	}
