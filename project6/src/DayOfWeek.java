		...
		scanner.close ();
 		...
 		if (dayOfWeek != null)
 		{
 			if (dayOfWeek.equalsIgnoreCase("saturday")
 				...
 				{
 				System.out.println("It's " + dayOfWeek + " the weekend. Let's Turn UP!!!");
 				}
 				...
 				{
 				System.out.println(dayOfWeek + " is a weekday, I have to go to YearUp.");
 				}
 			else
 			{
 				System.out.println(dayOfWeek + " is not a vaild day!!");
 			}
 		}
 	}
}
